...
#ifdef RT_SHADOW
// Limitation: assumes light source is FAR away, if light is infront of an object
// this will still returns a 0% visiblity for the light, which is not correct.
// Slightly cheaper than ClosestHitPoint, since we can stop at the first hit.
