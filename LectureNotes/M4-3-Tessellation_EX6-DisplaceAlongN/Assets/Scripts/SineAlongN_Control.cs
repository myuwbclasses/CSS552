using UnityEngine;
[System.Serializable]
public class OnObjAxisControl
{
    public bool Show = true;
    public bool ModeIsSine = true;
    [Range(0.01f, 0.2f)] public float Amplitude = .1f;
    [Range(0.05f, 2f)] public float PerPeriodOC = 0.2f; // OC-size that covers one peroid
                                    // 1 means, 1 OC-unit covers each sinusoidal period
}

public class SineAlongN_Control : MonoBehaviour {
    ...
    public OnObjAxisControl X_AxisControl = new OnObjAxisControl();
    public OnObjAxisControl Z_AxisControl = new OnObjAxisControl();
    ...
    bool DebugShowXHeightDelta = false;
    bool DebugShowZHeightDelta = false;
