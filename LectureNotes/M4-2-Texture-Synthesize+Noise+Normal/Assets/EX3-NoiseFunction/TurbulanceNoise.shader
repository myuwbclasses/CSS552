    ...
    SubShader
    {
        ...
        {   
            ...
            float4 frag(v2f i) : SV_TARGET { 
                float o = pow(_Frequency, 2);
                float n = perlinNoise(i.objPos);  // f = 1

                for (int f = 2; f < kMaxFrequency; f *= 2)
                    n += abs(HigherFrequency(o, f, i.objPos));
                    // This is really inefficient, but, at least we can examine effects
                    // of higher frequency results
